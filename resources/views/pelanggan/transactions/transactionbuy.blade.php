        ...
        <ul class="flex flex-col pl-0 mx-auto mb-0 list-none lg:flex-row xl:ml-auto">
            <li>
                <a class="block font-bold border-b-2 me-3 px-4 py-2 mr-2 transition-all lg-max:opacity-0 duration-250 ease-soft-in-out text-sm text-slate-700 lg:px-2"
                    ...
                    My Transaction
                    {{--  <span
                    class="bg-gray-200 text-orange-400 text-sm tracking-normal uppercase opacity-70 font-bold mr-2 px-3 py-1 rounded-lg p-4 ">{{$transactiondetail->count()}}</span>  --}}
                </a>
            </li>
            <li>
                        ...
                        <table id="dataTable" datatable id="datatable-search"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 px-8 border-b-2">
                                ...
                                <div>
                                    <div class="font-bold flex ml-4 mt-3">
                                        <h3 class="me-2 text-slate-700">{{ $transaksi->kode }}</h3>
                                        <button></button>
                                    ...
                                    <div class="text-center justify-end flex items-content-end mr-4">
                                        ...
                                        <div class="flex py-2.5 ">
                                            ...
                                            @elseif ($transaksi->transaction_status == 'CANCELLED')
                                                ...
                                                <span
                                                    class="font-semibold leading-tight text-sm text-slate-700">{{ $transaksi->tanggal }}</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <tbody>
                             <tr class="border-b-2">
                                    ...
                                    <td colspan="3" class="p-2 align-middle bg-transparent border-b ">
                                        @foreach ($transaksi->transaction_details as $detail)
                                            <div class="flex px-2 py-1 justify-between">
                                                <div class="flex flex-row">
                                                    <div>
                                                        <img src="{{ asset('storage/' . $detail->produk->gambar->first()->thumbnail) }}"
                                                    ...
                                                    <div class="flex flex-col justify-center">
                                                        ...
                                                        <p class="mb-0 leading-tight text-xs text-slate-400">
                                                            Warna : {{ $detail->produk->warnaproduk }},
                                                            {{ $detail->produk->ukuranproduk }}
                                                        </p>
                                                        <h6 class="mb-0 font-semibold leading-normal text-sm">
                                                            {{ $detail->qty }} x
                                                        </h6>
                    ...
                    <tr class="border bg-gray-100">
                        ...
                        <td colspan="2"
                            ...
                            <span class="font-semibold leading-tight text-md">Rp
                                {{ number_format($transaksi->total_harga - $transaksi->diskon + $transaksi->transaction_details[0]->ongkir) }}</span>
                        </td>
                    </tr>
