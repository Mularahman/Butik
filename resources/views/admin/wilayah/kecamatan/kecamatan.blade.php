...
@section('breadcrum')
    ...
    <nav>
        ...
        <h6 class="mb-0 font-bold capitalize">Kecamatan</h6>
    </nav>
    ...
    <div class="relative w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Tambah Data Kecamatan</h3>
                </div>
                <form class="space-y-6" action="/tambah_kecamatan" method="POST" >
                    @csrf
                    ...
                    <div>
                        <label for="kategori" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kecamatan</label>
                        <input type="text" name="kecamatan" id="kategori" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"  required>
                    </div>
                        ...
                        <div class="flex flex-wrap mt-0 -mx-3">
                            <div class="flex-none w-7/12 max-w-full px-3 mt-0 lg:w-1/2 lg:flex-none">
                                <h6
                                    ...
                                    Data Kecamatan <span
                                        class="bg-blue-100 text-blue-800 text-sm tracking-normal uppercase opacity-70 font-bold mr-2 px-3 py-1 rounded-lg p-4 dark:bg-blue-900 dark:text-blue-300">{{$kecamatan->count()}}</span>
                                </h6>
                            ...
                            <table id="dataTable" class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            class="p-2 leading-normal text-center align-middle bg-transparent border-b text-sm whitespace-nowrap">
                                            <span class="font-semibold leading-tight text-xs"> {{$item->kota->kota}} </span>
                                        </td>
                                        <td
                                            class="p-2 leading-normal text-center align-middle bg-transparent border-b text-sm whitespace-nowrap">
                                            <span class="font-semibold leading-tight text-xs"> {{$item->kecamatan}} </span>
                                        </td>
                                        {{--  <td
                                            class="p-2 leading-normal text-center align-middle bg-transparent border-b text-sm whitespace-nowrap">
                                        ...
                                        <button type="button"  data-modal-target="popup-modalkecamatan{{$item->id}}" data-modal-toggle="popup-modalkecamatan{{$item->id}}" data-tooltip-target="delete"
                                        ...
                                        <div id="popup-modalkecamatan{{$item->id}}" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                            @include('admin.wilayah.kecamatan.hapuskecamatan')
                                        </div>
                                        ...
                                        <button type="button"
                                       data-modal-target="editkecamatan{{$item->id}}" data-modal-toggle="editkecamatan{{$item->id}}" data-tooltip-target="edit"
                                        ...
                                        <div id="editkecamatan{{$item->id}}" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                            @include('admin.wilayah.kecamatan.editkecamatan')
                                        </div>
