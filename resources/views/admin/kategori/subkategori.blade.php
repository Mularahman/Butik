...
@section('breadcrum')
    <nav>
        ...
        <h6 class="mb-0 font-bold capitalize">Sub Kategori</h6>
    </nav>
@endsection
@section('content')
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="px-6 py-6 lg:px-8">
                                <div
                                    ...
                                    <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Tambah Data Sub Kategori
                                    </h3>
                                </div>
                                <form class="space-y-6" action="/tambah_subkategori" method="POST"
                                    ...
                                    <div>
                                        <label for="kategori"
                                            ...
                                            kategori</label>
                                        <input type="text" name="subkategori" id="subkategori"
                        ...
                        <div class="flex flex-wrap mt-0 -mx-3">
                            <div class="flex-none w-7/12 max-w-full px-3 mt-0 lg:w-1/2 lg:flex-none">
                                <h6
                                    ...
                                    Data Sub Kategori <span
                                        class="bg-blue-100 text-blue-800 text-sm tracking-normal uppercase opacity-70 font-bold mr-2 px-3 py-1 rounded-lg p-4 dark:bg-blue-900 dark:text-blue-300">{{ $subkategori->count() }}</span>
                                </h6>
                                    ...
                                    @foreach ($subkategori as $item)
                                        <tr>
                                            ...
                                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap">
                                                <div class="mt-2 avatar-group">
                                                    <div>
                                                        ...
                                                        <img src=" {{ asset('storage/' . $item->kategori->icon) }}"
                                            ...
                                            <td
                                                ...
                                                <span class="font-semibold leading-tight text-xs"> {{ $item->kategori->kategori }}
                                                </span>
                                            </td>
                                            <td
                                                class="p-2 leading-normal text-center align-middle bg-transparent border-b text-sm whitespace-nowrap">
                                                <span class="font-semibold leading-tight text-xs"> {{ $item->subkategori }}
                                                </span>
                                            </td>
                                            <td
                                                class="p-2 leading-normal text-center align-middle bg-transparent border-b text-sm whitespace-nowrap">

                                                <button type="button" data-modal-target="subkategori{{ $item->id }}"
                                                    data-modal-toggle="subkategori{{ $item->id }}"
                                                ...
                                                <div id="subkategori{{ $item->id }}" tabindex="-1"
                                                    class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                                    @include('admin.kategori.hapussubkategori')
                                                </div>
                                                ...
                                                <button type="button" data-modal-target="edit{{ $item->id }}"
                                                    data-modal-toggle="edit{{ $item->id }}" data-tooltip-target="edit"
                                                ...
                                                <div id="edit{{ $item->id }}" tabindex="-1" aria-hidden="true"
                                                    class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                                    @include('admin.kategori.editsubkategori')
                                                </div>
