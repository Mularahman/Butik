                        ...
                        <div
                            ...
                            <div class="flex-auto p-6">
                                ...
                                <form role="form text-left" action="/register" method="post">
                                    ...
                                    <div class="mb-4">
                                        <label for="countries"
                                            class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Store</label>
                                        <label for="countries"
                                            class="block mb-2 text-sm font-medium text-muted dark:text-white">Apakah anda ingin membuka toko ?</label>
                                            <div class="flex">
                                    ...
                                    <div class="mb-4"  v-if="is_store_open">
                                        ...
                                        <label for="toko_baru"
                                            ...
                                            <select id="toko_baru" disabled name="kategori_id"
                                    ...
                                    <p class="mt-4 mb-0 leading-normal text-sm">Already have an account? <a
                                            href="/login" class="font-bold text-slate-700">Sign in</a></p>
                                </form>
                            </div>
                        </div>
                    </div>
