...
@section('breadcrum')
    ...
    <nav>
        ...
        <h6 class="mb-0 font-bold capitalize">Toko Berlangganan</h6>
    </nav>
...
<a href="/laporan-tokoberlangganan-admin-cetak" class="inline-block px-6 py-3 font-bold text-center text-white uppercase align-middle transition-all rounded-lg cursor-pointer bg-gradient-to-tl from-purple-700 to-pink-500 leading-pro text-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25 hover:scale-105 active:opacity-85 hover:shadow-soft-xs mb-3" type="button">
    Download
</a>
                    ...
                    <div class="border-black/12.5  mb-0 rounded-t-2xl border-b-0 border-solid bg-white p-6 pb-0">
                        ...
                        <div class="flex flex-wrap mt-0 -mx-3">
                            ...
                            <div class="flex-none w-5/12 max-w-full px-3 my-auto text-right lg:w-1/2 lg:flex-none">
                                ...
                                <form class="flex items-center" action="/laporan-tokoberlangganan-admin" method="GET">
                            ...
                            <table id="dataTable" class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                                <thead class="align-bottom">
                                    <tr>
                                        ...
                                        <th
                                            class="px-6 py-3 font-bold tracking-normal text-center uppercase align-middle bg-transparent border-b letter border-b-solid text-xs whitespace-nowrap border-b-gray-200 text-slate-400 opacity-70">Nama Toko</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <span class="font-semibold leading-tight text-xs"> {{$item->nama_toko}} </span>
                                        </td>
                                        <td
                                            class="p-2 leading-normal text-center align-middle bg-transparent border-b text-sm whitespace-nowrap">
                                        ...
                                        <td
                                            class="p-2 leading-normal text-center align-middle bg-transparent border-b text-sm whitespace-nowrap">
                                            <span class="font-semibold leading-tight text-xs"> {{$item->no_hp}} </span>
                                        </td>
                                        <td
                                            class="p-2 leading-normal text-center align-middle bg-transparent border-b text-sm whitespace-nowrap">
                                            <span class="font-semibold leading-tight text-xs"> {{$item->alamat1}} </span>
                                        </td>
                                        <td
                                            class="p-2 leading-normal text-center align-middle bg-transparent border-b text-sm whitespace-nowrap">
                                            @if ($item->status_toko == 1)
                                            <span class="font-semibold leading-tight text-xs"> Aktif </span>
                                            @else
                                            <span class="font-semibold leading-tight text-xs"> Tidak Aktif </span>
                                            @endif
                                        </td>
