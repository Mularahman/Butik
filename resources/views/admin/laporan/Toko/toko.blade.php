...
@section('breadcrum')
    ...
    <nav>
        ...
        <h6 class="mb-0 font-bold capitalize">Toko Terdaftar</h6>
    </nav>
...
<a href="/laporan-toko-admin-cetak" class="inline-block px-6 py-3 font-bold text-center text-white uppercase align-middle transition-all rounded-lg cursor-pointer bg-gradient-to-tl from-purple-700 to-pink-500 leading-pro text-xs ease-soft-in tracking-tight-soft shadow-soft-md bg-150 bg-x-25 hover:scale-105 active:opacity-85 hover:shadow-soft-xs mb-3" type="button">
    Download
</a>
                    ...
                    <div class="border-black/12.5  mb-0 rounded-t-2xl border-b-0 border-solid bg-white p-6 pb-0">
                        ...
                        <div class="flex flex-wrap mt-0 -mx-3">
                            ...
                            <div class="flex-none w-5/12 max-w-full px-3 my-auto text-right lg:w-1/2 lg:flex-none">
                                ...
                                <form class="flex items-center" action="/laporan-toko-admin" method="GET">
