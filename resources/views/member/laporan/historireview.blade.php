...
@section('breadcrum')
    <nav>
        ...
        <h6 class="mb-0 font-bold capitalize">Laporan Ulasan</h6>
    </nav>
@endsection
@section('content')
                    ...
                    <table id="dataTable" datatable id="datatable-search"
                        ...
                        <div>
                            <div class="font-bold flex ml-4 mb-4 mt-3">
                                <h3 class="me-2">Laporan Ulasan</h3>
                            ...
                            <div class="px-4 ">
                                <form action="/laporan-ulasan-cetak" method="get">
                                    <div class="flex">
                                    <div>
                        ...
                        <div>
                            <div class="text-center justify-end flex items-content-end mr-4">
                                ...
                                <div class="flex py-2.5">
                                    ...
                                    <form action="/laporan-ulasan" method="get">
