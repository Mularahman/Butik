...
@section('breadcrum')
    <nav>
        ...
        <h6 class="mb-0 font-bold capitalize">Laporan Transaksi</h6>
    </nav>
@endsection
@section('content')
                    ...
                    <table id="dataTable" datatable id="datatable-search"
                        ...
                        <div>
                            <div class="font-bold flex ml-4 mb-4 mt-3">
                                <h3 class="me-2">Laporan Transaksi</h3>
                                <span
                             ...
                             <div class="px-4 ">
                                <form action="/laporan-transaksi-cetak" method="get">
                                    <div class="flex">
                                    <div>
                        ...
                        <tbody>
                            <tr class="border-b-2 font-bold  bg-gray-100">
                                ...
                                <td
                                    class="p-2 leading-normal text-center align-middle bg-transparent  text-sm whitespace-nowrap">
                                    <span class=" leading-tight ">Status Transaksi</span>
                                </td>
